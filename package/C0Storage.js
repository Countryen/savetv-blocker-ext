...
/**
 * Class.
 * Chrome-API Storage handling for save/load of data.
...
function C0Storage(type) {
    ...
    this.setNewObject = function(name) {
        ...
        o[name] = {};
        this.store.set(o);
        this.log.push("C0Storage[" + this.type + "].setNewObject(" + name + ")");
    };
    ...
    this.setNewValue = function(name) {
        ...
        o[name] = null;
        this.store.set(o);
        this.log.push("C0Storage[" + this.type + "].setNewValue(" + name + ")");
    };
